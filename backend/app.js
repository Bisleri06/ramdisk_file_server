...
const base_path="/home/holy/projects/file_server/uploads";
const files=new Set();
...
app.listen(3001,(req,res)=>{
    ...
    async function execute(){
        ...
        //4GB ram disk
        await exec("sudo mount -t tmpfs -o size=4g tmpfs /home/holy/projects/file_server/uploads");
    }
...
process.on('SIGINT', function() {
    ...
    console.log(files);
    async function execute(){
        await exec("mkdir /home/holy/projects/file_server/leftovers");
        await exec("cp -r /home/holy/projects/file_server/uploads /home/holy/projects/file_server/leftovers");
        await exec("sudo umount /home/holy/projects/file_server/uploads");
    }
